...
"}")
        ...
        self.frame_29.setGeometry(QtCore.QRect(1190, 840, 231, 138))
...
"}")
        ...
        self.frame_30.setGeometry(QtCore.QRect(424, 1039, 221, 138))
...
"}")
        ...
        self.autoTrace = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        self.autoTrace.setMinimumSize(QtCore.QSize(0, 24))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.autoTrace.setFont(font)
        self.autoTrace.setStyleSheet("QPushButton{\n"
"\n"
"    background-color: rgb(255, 255, 255);\n"
"    border: 1px solid grey;\n"
"    border-radius: 5px;\n"
"}")
        ...
        self.verticalLayout_2.addWidget(self.autoTrace)
        ...
        self.menu = QtWidgets.QMenu(parent=self.menufile)
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap("assets/arduino.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.action_json = QtGui.QAction(parent=MainWindow)
        self.action_json.setObjectName("action_json")
        self.action_Arduino_ino = QtGui.QAction(parent=MainWindow)
        self.action_Arduino_ino.setObjectName("action_Arduino_ino")
        self.menu.addAction(self.action_json)
        self.menu.addAction(self.action_Arduino_ino)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.autoTrace.setText(_translate("MainWindow", "Автораспределение"))
        self.menufile.setTitle(_translate("MainWindow", "&Файл"))
        self.menu.setTitle(_translate("MainWindow", "&Экспортировать"))
        self.menu_2.setTitle(_translate("MainWindow", "Инуструменты"))
        ...
        self.action_New.setText(_translate("MainWindow", "&Новый файл"))
        self.action_Save.setText(_translate("MainWindow", "&Сохранить"))
        self.action_json.setText(_translate("MainWindow", "json file (.json)"))
        self.action_Arduino_ino.setText(_translate("MainWindow", "Arduino (.ino)"))
